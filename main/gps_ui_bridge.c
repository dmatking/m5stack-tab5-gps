...
static void tick(void)
{
    ...
    // Deliberately not touched: trip stats (needs an accumulator, a
    // separate feature) and battery percent (no fuel-gauge hardware wired
    // up yet) -- see gps_ui_bridge.h. Both stay at their ui_home_create()

...
// deterministic per (tile_x, tile_y): a hashed background color, a coarse
// checkerboard sub-pattern, and a contrasting border, so panning can be
// visually verified (tiles line up, no gaps) without needing real map data.
//
